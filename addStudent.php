...
<form name="frmLogin" action="addStudent.php" method="post" enctype= "multipart/form-data">
  <div class="mb-3">
    ...
    <input name="studentID" type="text" placeholder = "e.g.20000001, 50000000" maxlength ="8" class="form-control" aria-describedby="emailHelp">
  <div class="mb-3">
    <label>Student Password</label>
    <input name="password" type="text" placeholder = "e.g.password" class="form-control">
  </div>
  <div class="mb-3">
    <label>Student DOB:</label>
    <input name="DateOfBirth" type="date" placeholder = "e.g. 01/02/2000" class="form-control">
  </div>
  <div class="mb-3">
    <label>Student FirstName:</label>
    <input name="FName" type="text" placeholder = "e.g. John" class="form-control">
  </div>
  <div class="mb-3">
    <label>Student Lastname:</label>
    <input name="LName" type="text" placeholder = "e.g. Doe" class="form-control">
  </div>
  <div class="mb-3">
    <label>Student House & Street:</label>
    <input name="House" type="text" placeholder = "e.g. 10 Richmond Lane" class="form-control">
  </div>
  <div class="mb-3">
    <label>Student Town</label>
    <input name="Town" type="text" placeholder = "e.g. Slough" class="form-control">
  </div>
  <div class="mb-3">
    <label>Student County</label>
    <input name="County" type="text" placeholder = "e.g. Berkshire" class="form-control">
  </div>
  <div class="mb-3">
    <label>Student Country</label>
    <input name="Country" type="text" placeholder = "e.g. United Kingdom" class="form-control" >
  </div>
  <div class="mb-3">
    <label>Student Postcode</label>
    <input name="Postcode" type="text" placeholder = "e.g. SL2 2PA" class="form-control" >
  </div>
  <div class="mb-3">
